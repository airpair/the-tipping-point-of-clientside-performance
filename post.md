...
One way to do this is to embed this JSON array on the first page response, under something like a ```<script id="commentsData" type="application/json">``` tag. This technique is also known as JSON bootstrapping.
