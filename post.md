...
In this way, the content above the fold has the absolutely necessary information to be advertised about today's edition, which is defined as critical. Everything else will then appear then below the fold and will only be revealed after you have bought and opened the newspaper.
